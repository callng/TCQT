        ...
        return when (this) {
            ...
            is FloatArray, is DoubleArray, is BooleanArray, is CharArray -> buildJsonArray {
                ...
                for (i in 0 until length) {
                    add(
                        java.lang.reflect.Array.get(this@toJsonElement, i)
                            .toJsonElement(maxDepth - 1, withSuper, visited)
                    )
                }
            }
            ...
            is Bundle -> buildJsonObject {
                ...
                for (key in this@toJsonElement.keySet()) {
                    ...
                    put(
                        key,
                        this@toJsonElement.get(key).toJsonElement(maxDepth - 1, withSuper, visited)
                    )
                }
            }
